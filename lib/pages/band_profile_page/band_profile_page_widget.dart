...
import '/components/band_settings/band_settings_widget.dart';
                  ...
                  children: [
                    Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'BAND_PROFILE_PAGE_PAGE__BTN_ON_TAP');
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.network(
                                        bandProfilePageBandsRecord.bandPhotoUrl,
                                      ).image,
                                    ),
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 10.0, 0.0, 0.0),
                                            child: Text(
                                              bandProfilePageBandsRecord.genre,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
